describe('saywhen', () => {
    beforeEach(function() { this.spy = jasmine.createSpy('spy'); });
    ...
    it('andFake', function() {
        ...
        when(this.spy).isCalledWith(33).then(function(arg) { return arg + 1; });
    ...
    it('throw', function() {
        when(this.spy)
          .isCalledWith(jasmine.any(String))
          .thenThrow(new TypeError('A Number? Really?'));
    ...
    it('multiple calls', function() {
        when(this.spy)
          .isCalled.thenReturn('first time')
